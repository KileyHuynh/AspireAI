...
system_role2 = "Provide a real motivational quotes with the people who came up with them. make it for college students who are exploring their business career paths. The format is quote —person"
...
#    st.caption(":red[NOTE: These action steps are generated by AI and may not completely align with your specific career goals. Please review and modify them as needed to better suit your aspirations.]")
    prompt2 = "Format it as quote —person"
